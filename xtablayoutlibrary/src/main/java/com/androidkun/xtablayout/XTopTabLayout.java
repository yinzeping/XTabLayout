...
public class XTopTabLayout extends HorizontalScrollView {
    ...
    public interface OnTabSelectedListener {
         ...
         */
        public void onTabSelected(XTopTabLayout.Tab tab);
         ...
         */
        public void onTabUnselected(XTopTabLayout.Tab tab);
         ...
         */
        public void onTabReselected(XTopTabLayout.Tab tab);
    }

    private final ArrayList<Tab> mTabs = new ArrayList<>();
    private XTopTabLayout.Tab mSelectedTab;

    private final XTopTabLayout.SlidingTabStrip mTabStrip;
    ...
    private XTopTabLayout.OnTabSelectedListener mOnTabSelectedListener;
    ...
    private XTopTabLayout.TabLayoutOnPageChangeListener mPageChangeListener;

    // Pool we use as a simple RecyclerBin
    private final Pools.Pool<TabView> mTabViewPool = new Pools.SimplePool<>(12);

    public XTopTabLayout(Context context) {
        this(context, null);
    }

    public XTopTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XTopTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // Add the TabStrip
        mTabStrip = new XTopTabLayout.SlidingTabStrip(context);
...
//        invalidate();
     ...
     */
    public void addTab(@NonNull XTopTabLayout.Tab tab) {
     ...
     */
    public void addTab(@NonNull XTopTabLayout.Tab tab, int position) {
     ...
     */
    public void addTab(@NonNull XTopTabLayout.Tab tab, boolean setSelected) {
        if (tab.mParent != this) {
     ...
     * @param setSelected True if the added tab should become the selected tab.
     */
    public void addTab(@NonNull XTopTabLayout.Tab tab, int position, boolean setSelected) {
        if (tab.mParent != this) {
            throw new IllegalArgumentException("Tab belongs to a different TabLayout.");
        }
    ...
    private void addTabFromItemView(@NonNull TabItem item) {
        final XTopTabLayout.Tab tab = newTab();
        if (item.mText != null) {
     ...
     */
    public void setOnTabSelectedListener(XTopTabLayout.OnTabSelectedListener onTabSelectedListener) {
        mOnTabSelectedListener = onTabSelectedListener;
    }

    public void addOnTabSelectedListener(XTopTabLayout.OnTabSelectedListener onTabSelectedListener) {
        mOnTabSelectedListenerList.add(onTabSelectedListener);
    }

    @NonNull
    public XTopTabLayout.Tab newTab() {
        XTopTabLayout.Tab tab = sTabPool.acquire();
        if (tab == null) {
            tab = new XTopTabLayout.Tab();
        }
        tab.mParent = this;
     ...
     */
    @Nullable
    public XTopTabLayout.Tab getTabAt(int index) {
     ...
     */
    public void removeTab(XTopTabLayout.Tab tab) {
        if (tab.mParent != this) {
    ...
    public void removeTabAt(int position) {
        ...
        final XTopTabLayout.Tab removedTab = mTabs.remove(position);
        if (removedTab != null) {
            removedTab.reset();
    ...
    public void removeAllTabs() {
        ...
        for (final Iterator<Tab> i = mTabs.iterator(); i.hasNext(); ) {
            final XTopTabLayout.Tab tab = i.next();
            i.remove();
            tab.reset();
    ...
    public void setupWithViewPager(@Nullable final ViewPager viewPager) {
        ...
        if (viewPager != null) {
            ...
            if (mPageChangeListener == null) {
                mPageChangeListener = new XTopTabLayout.TabLayoutOnPageChangeListener(this);
            }
            mPageChangeListener.reset();
            viewPager.addOnPageChangeListener(mPageChangeListener);

            // Now we'll add a tab selected listener to set ViewPager's current item
            setOnTabSelectedListener(new XTopTabLayout.ViewPagerOnTabSelectedListener(viewPager));
    ...
    private void setPagerAdapter(@Nullable final PagerAdapter adapter, final boolean addObserver) {
        ...
        if (addObserver && adapter != null) {
            ...
            if (mPagerAdapterObserver == null) {
                mPagerAdapterObserver = new XTopTabLayout.PagerAdapterObserver();
            }
    ...
    private XTopTabLayout.TabView createTabView(@NonNull final XTopTabLayout.Tab tab) {
        XTopTabLayout.TabView tabView = mTabViewPool != null ? mTabViewPool.acquire() : null;
        if (tabView == null) {
            tabView = new XTopTabLayout.TabView(getContext());
        }
        tabView.setTab(tab);
    ...
    private void configureTab(XTopTabLayout.Tab tab, int position) {
    ...
    private void addTabView(XTopTabLayout.Tab tab, boolean setSelected) {
        final XTopTabLayout.TabView tabView = tab.mView;
    ...
    private void addTabView(XTopTabLayout.Tab tab, int position, boolean setSelected) {
        final XTopTabLayout.TabView tabView = tab.mView;
    ...
    private void removeTabViewAt(int position) {
        final XTopTabLayout.TabView view = (XTopTabLayout.TabView) mTabStrip.getChildAt(position);
    ...
    private void animateToTab(int newPosition) {
        if (newPosition == XTopTabLayout.Tab.INVALID_POSITION) {
            return;
        }
    ...
    void selectTab(XTopTabLayout.Tab tab) {
        selectTab(tab, true);
    }

    void selectTab(XTopTabLayout.Tab tab, boolean updateIndicator) {
        if (mSelectedTab == tab) {
            ...
            if (updateIndicator) {
                final int newPosition = tab != null ? tab.getPosition() : XTopTabLayout.Tab.INVALID_POSITION;
                if (newPosition != XTopTabLayout.Tab.INVALID_POSITION) {
                    setSelectedTabView(newPosition);
                }
                if ((mSelectedTab == null || mSelectedTab.getPosition() == XTopTabLayout.Tab.INVALID_POSITION)
                        && newPosition != XTopTabLayout.Tab.INVALID_POSITION) {
    ...
    public static final class Tab {
        ...
        private XTopTabLayout mParent;
        private XTopTabLayout.TabView mView;
         ...
         */
        @NonNull
        public XTopTabLayout.Tab setTag(@Nullable Object tag) {
            mTag = tag;
            return this;
        }
         ...
         */
        @NonNull
        public XTopTabLayout.Tab setCustomView(@Nullable View view) {
            mCustomView = view;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public XTopTabLayout.Tab setCustomView(@LayoutRes int resId) {
         ...
         */
        @NonNull
        public XTopTabLayout.Tab setIcon(@Nullable Drawable icon) {
            mIcon = icon;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public XTopTabLayout.Tab setIcon(@DrawableRes int resId) {
            if (mParent == null) {
         ...
         */
        @NonNull
        public XTopTabLayout.Tab setText(@Nullable CharSequence text) {
            mText = text;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public XTopTabLayout.Tab setText(@StringRes int resId) {
            if (mParent == null) {
                throw new IllegalArgumentException("Tab not attached to a TabLayout");
            }
         ...
         */
        @NonNull
        public XTopTabLayout.Tab setContentDescription(@StringRes int resId) {
            if (mParent == null) {
                throw new IllegalArgumentException("Tab not attached to a TabLayout");
            }
         ...
         */
        @NonNull
        public XTopTabLayout.Tab setContentDescription(@Nullable CharSequence contentDesc) {
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        private XTopTabLayout.Tab mTab;
...
//                        mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
        ...
        private void setTab(@Nullable final XTopTabLayout.Tab tab) {
            if (tab != mTab) {
                mTab = tab;
                update();
            }
        ...
        final void update() {
            final XTopTabLayout.Tab tab = mTab;
        ...
        public XTopTabLayout.Tab getTab() {
            return mTab;
        }
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
               ...
               /* int maxWidth = mIndicatorRight - mIndicatorLeft;
                ...
                canvas.drawRect(mIndicatorLeft, getTop(),
...
//                        mIndicatorRight, getHeight(), mSelectedIndicatorPaint);
    ...
    private int getDefaultHeight() {
        ...
        for (int i = 0, count = mTabs.size(); i < count; i++) {
            XTopTabLayout.Tab tab = mTabs.get(i);
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<XTopTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(XTopTabLayout tabLayout) {
        ...
        public void onPageScrolled(int position, float positionOffset,
            ...
            final XTopTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
     ...
     */
    public static class ViewPagerOnTabSelectedListener implements XTopTabLayout.OnTabSelectedListener {
